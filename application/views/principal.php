...
<body>
	...
	<div id="footer">
			<div id="socialbar">
						...
						<ul>
							<li><a href="https://twitter.com/@SportsAppCD"><img id="t" src="<?=base_url()?>assets/images/t.png" width=18 height=20></a></li>
							<li><a href="https://www.facebook.com/sportsapp.cd"><img id="f" src="<?=base_url()?>assets/images/f.png" width=18 height=20></a></li>
						</ul>
					</div>
